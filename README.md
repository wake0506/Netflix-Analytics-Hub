...
git clone [https://github.com/wake0506/Netflix-Analytics-Hub.git](https://github.com/wake0506/Netflix-Analytics-Hub.git)
...
Ntitles.csv
Data
The core dataset containing Netflix movies and TV shows details.
微信图片_20251121083856_35_777.png
retouch_2025112400100760.png
...
Interaction: Static overview page.
2. Macro Overview
...
Tab                    Focus Area               Detailed Analysis/Visualizations
Geography              Global Strategy          Choropleth Map of primary content countries and a bar chart of the Top 10 Producing Countries.
Duration & Operations  Content Format Metrics   Histograms for Movie durations, bar charts for TV Show seasons, scatter plots of release year vs. duration, and analysis of content release day patterns.
Genres                 Thematic Composition     Treemaps and bar charts to visualize the popularity and hierarchy of the most common content    genres.
Talent & Ratings       Audience & Creators      Bar charts displaying Content Rating distributions (e.g., TV-MA, PG-13) and a ranked list of the Top 10 most prolific Directors.
4. Conclusions
...
Content Type           Filters titles to show only Movie or TV Show, or both.                        Analyze only the growth trends of TV series.
Date Added Range       Filters based on the year the content was added to the platform.              Focus analysis on content added since 2018 to see recent trends.
Primary Country        Filters titles whose production country matches any of the selected options.  Compare content characteristics exclusively from the United States and India.
